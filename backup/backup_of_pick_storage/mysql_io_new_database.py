...
if __name__ == '__main__':
    ...
    rule_scope = sql_rule_scope("SELECT * FROM mw_transport.mwt_contract_rule_scope;")
    json_str = json.dumps(rule_scope, indent=4, ensure_ascii=False)
    with open('../../algorithms/src/core/FE_Pick_Storage/rule_scope.json', 'w') as json_file:
