...
order_data = sql_order("SELECT * FROM logistics_oms.oms_shipper_order where confirm_date > '2019-06-10 15:41:33';")
...
ship_data = sql_ship('SELECT * FROM logistics_oms.oms_shipper;')
...
receiver_data = sql_receiver('SELECT * FROM logistics_oms.oms_receiver;')
...
order_list_data = sql_order_list(
    "SELECT * FROM logistics_oms.oms_shipper_order_list where create_time > '2019-06-10 15:41:33' and status > 0;")
...
receiver_transport_data = sql_receiver_transport('SELECT * FROM logistics_oms.oms_receiver_transport where status>0;')
...
tms_order_list_data = sql_tms_order_list("SELECT * FROM logistics_tms.tms_order_list;")
